...
class ToolHelper
{
    ...
    public static function fetchInseeAPIToken(){
        ...
        $headers = array();
        $headers[] = 'Authorization: Basic TlpfcmZURkpfUXhKY3laemY3cVBVNnVPNHI4YTpWaEkwVUZxTmx3UXFsdTdRSlZKMUZpdk1Qdmth';
    ...
    public static function fetchDataFromInseeAPI($token, $q, $mapping_function = false){
        ...
        if(!isset($api_data['etablissements'])){
            return [];
        }

        $entities = [];

        foreach($api_data['etablissements'] as $entity){
            $mapping = [];
